...
$subject1 = "New Enquiry From Website - Contact Us";
	...
	$subject2 = "Acknowledgement from Comfie";
...
This is an auto-response from Comfie  help desk. It will be our best endeavor to revert to you in the earliest possible time.</em>
...
$mail->setFrom('ilovemyskin@satinskin.in');
...
$mail->Port = 587;  */                   
 ...
 //Set who the message is to be sent from
$mail1->setFrom('ilovemyskin@satinskin.in');
